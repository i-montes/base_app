...
$(document).ready(function() {
    ...
    /* -- View-Restaurant -- */
    $("#restaurant-open").on("click", function(e) {
        e.preventDefault();
        $(".view-restaurant-sidebar-overlay").css({"background": "rgba(0,0,0,0.4)", "position": "fixed"});
        $("#view-restaurant-sidebar").addClass("sidebarshow");
    }); 
    $("#view-restaurant-close").on("click", function(e) {
        e.preventDefault();
        $(".view-restaurant-sidebar-overlay").css({"background": "transparent", "position": "initial"});
        $("#view-restaurant-sidebar").removeClass("sidebarshow");
    });
